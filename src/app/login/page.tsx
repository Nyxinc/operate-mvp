...
export default function LoginPage() {
  // Simple state to ensure client-side rendering is ready
  ...
  if (!mounted) {
    return null; // Don't render anything until client side is ready
  }
    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-4rem)] p-4">
      <div className="w-full max-w-md p-8 space-y-4 bg-white shadow-lg rounded-lg border border-gray-200">
        ...
        <Auth
          ...
          view="sign_in" // Default view is sign-in
          appearance={{ theme: ThemeSupa }}
          theme="default"
          providers={['google']} // Allows Google login (OAuth) as per the plan
          // No need for redirectTo, the useEffect handles the navigation
